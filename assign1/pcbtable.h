...
private:
    ...
    // choose a data structure for the PCBTable. Using vectors as our data structure and our 
    //algorithm will be using heap sort.
    // You can use an array of PCB pointers, e.g. vector<PCB *>. 
    vector<PCB*> pcb;// array of PCB pointers using vectors
